        ...
        if ($result) {
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                <div class="card" style="width: 18rem;">
                    <div class="card-body">
                        <h5 class="card-title text-center text-success">' . $date . '</h5>
                        ...
                        <div class="d-flex align-item-center justify-content-between" name="id">
                            <a href="delete-studassignment.php?deleteitem='. $id. '" onclick="return checkstudassigndelete()"> <i class="fa-solid fa-trash-can text-danger"></i></a>
...
<script>
function checkstudassigndelete() {
