        ...
        <div class="container">
            <div class="row center-el">
               ...
               ?>
                    <div class="row">
                        <div class="col-lg-6">
                            <form method="POST" action="signUp-check.php" class="form-group center-el h-100"
                                ...
                                <p>SignUp to Nkap-Learning<span><img src="../images/nkap-removebg-preview.png" alt=""
                                ...
                                <div class="div my-3">
                                    ...
                                    <input type="file" id="file" name="file" class="form-control px-3 py-2 my-2"
                                        placeholder="choose an image" required accept="image/*">
                                    ...
                                    <input type="submit" class="form-btn btn btn-lg border px-3 py-2 my-4"
                                        value="SignUp" name="submit">
                                    <span>already have an account ?<a href="index.php" class="text-italic color">
                                            SignIn</a></span><br>
                                </div>
                            </form>
                        ...
                        <div class="col-lg-6">
                            <img src="images/auth2.jpg" alt="" class="card-img" width="100%">
                        </div>
                    </div>
                </div>
            </div>
