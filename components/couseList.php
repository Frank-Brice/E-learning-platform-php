...
<div id="homeCourses" class="row courses my-5 d-flex align-content-center justify-content-center">
    <div class="col-lg-3  d-flex justify-content-space-between">
        <div class="card" style="width: 18rem;">
            <video poster="/images/couse1.jpg" height="173px" controls class="card-img-top">
    ...
    <div class="col-lg-3  d-flex justify-content-space-between">
        <div class="card" style="width: 18rem;">
            ...
            <video poster="/images/couse4.jpg" height="173px" controls class="card-img-top">
                <source src="images/video4.mp4" type="video/mp4" class="card-video-top">
            </video>
            <div class="card-body">
                ...
                <div class="course-card-content">
                    ...
                    <div class="card-content">
                        <h6>John Doe<br><span class="badge text-bg-light text-success">Top mentor</span></h6>
                        <p>Lecturer at E. university</p>
                    </div>
                </div>
            </div>
        </div>
