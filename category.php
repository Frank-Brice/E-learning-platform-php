...
?>
<div class="container">
    <div class="row catbanner my-2">
        <img src="./images/banners/catbanner/<?php echo $category ?>.jpg " alt="<?php echo $category ?>" width="100%">
    </div>
    <div id="mainCourse" class="row courses my-3 d-flex text-align-center justify-content-center">
        <?php
        if ($result) {
            if (mysqli_num_rows($result) > 1) {
                ...
                echo '<h1 class="text-danger d-flex text-align-center justify-content-center">No Course yet for this category!</h1>';
            }
