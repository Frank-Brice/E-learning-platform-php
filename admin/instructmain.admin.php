...
<head>
    ...
    <title>Instructor <?php echo $_SESSION["name"]; ?></title>
                            ...
                            <div class="info-box mb-3">
                                ...
                                <div class="info-box-content">
                                    ...
                                    <?php
                                       ...
                                       if ($instructor_total = mysqli_num_rows($result)) {
                                        echo '<h4> '.$instructor_total.' </h4>';
                                       } else {
                                        echo '<h4 class="text-danger"> No instructor </h4>';
                                       }
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="card">
                                ...
                                <!-- /.card-header -->
                                <!-- User Image -->
                                <?php include "./instructuser.admin.php"; ?>
                                <!-- /.card-body -->
