...
<div class="card-body p-0">
  ...
  while($row = mysqli_fetch_assoc($result)){
     ...
     $id = $row['id'];
    echo '<li>
            <img src="./instruct-image/'.$image.'" alt="User Image">
            <a class="users-list-name" href="#">'.$name.'</a>
            <span class="users-list-date">'.$email.'</span>
            <a href="delete-instructor.php?deleteinstruct='. $id. '" onclick="return check()"> <i class="fa-solid fa-trash-can text-danger"></i></a>
        </li>';
  }
} 
